...
// BUG 2: describe() takes a MenuItem, but lunchCombo is a ComboDeal
console.log(describe(brownie));
// BUG 3: price was the string "7.00"; Partial<MenuItem> requires number.
console.log(updateItem(soup, { price: 7.00 }));
// BUG 4: 'calories' is nested inside 'nutrition', not top-level.
